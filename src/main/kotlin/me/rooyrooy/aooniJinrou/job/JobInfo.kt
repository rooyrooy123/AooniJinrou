...
enum class JobInfo(val displayName: String, val description: String,val descriptionTitle: String,val color: String,val item : Material) {
    AOONI(
        displayName = "§1青鬼",
        ...
        descriptionTitle = "ばれないように全員を食べましょう",
        color = "§9",
    ...
    HIROSHI(
        ...
        description = "§bひろしは、チェストから鍵の欠片などを回収しまくり、地下室や5階の鍵をつくろう！" +
                ...
                "脱出を目指そう！",
        descriptionTitle = "青鬼を探しつつ、館から脱出しましょう！",
        color = "§d",
        item = Material.PINK_WOOL
    ),
    HUNTER(
        displayName = "§c狩人",
        description = "§c狩人は§b§n基本無敵§bで、§c§n手持ちの弓でプレイヤーを一撃で撃破できます§4(※クールタイムあり)。" +
                "§a§n弓のクールタイム中以外は走ることができます！§bひろしを誤射すると、一定時間、青鬼以外に盲目が付与されます。",
        descriptionTitle = "ひろしからのタレコミをもとに、青鬼を射抜きましょう",
        color = "§c",
    ...
    MIKA(
        ...
        descriptionTitle = "青鬼陣営を推測し、サポートをしましょう！",
        color = "§5",
    ...
    TAKESHI(
        ...
        descriptionTitle = "どちらかの勝利時に180秒間タンスに滞在し、生存していれば勝利",
        color = "§e",
    ...
    TAKUROU(
        ...
        descriptionTitle = "青鬼殴られ、狩人に射抜かれると勝利！",
        color = "§a",
