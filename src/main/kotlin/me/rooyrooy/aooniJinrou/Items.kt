...
enum class Items(private val displayName: String, private val lore: List<String>, private val material: Material) {
    ...
    KEY_GOLD("§6§l§n金の鍵", listOf("§7§l§n銀の鍵§bも取得すると、","§1§l§n青鬼の鍵§bを入手できます。","§cヒント§f➤","§7§l§n銀の鍵§bは最上階にあります！"),Material.GOLD_INGOT),
    KEY_AOONI("§1§l§n青鬼の鍵", listOf("§b館の脱出に使用する鍵。","§e脱出場所の看板を右クリックで脱出します。","§7残り120秒から使用可能！"),Material.DIAMOND),
